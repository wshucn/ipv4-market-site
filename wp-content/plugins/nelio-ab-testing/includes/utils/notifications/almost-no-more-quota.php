							...
							<div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
								<div class="card"
									...
									<p style="font-size: 18px; line-height: 24px;">
										<?php
											echo esc_html_x( 'This is to inform you that you might run out of quota soon, as you have less than 20% of your subscription’s total page views available.', 'text', 'nelio-ab-testing' );
										?>
									</p>
									...
									<?php if ( nab_are_subscription_controls_disabled() ) { ?>
										<p style="font-size: 18px; line-height: 24px;">
											<?php
												echo wp_kses_data( _x( 'If you want to resume the tracking right away, you can buy more quota using the option available in your <strong>Account Details</strong> and get some additional page views.', 'text', 'nelio-ab-testing' ) );
											?>
										</p>
