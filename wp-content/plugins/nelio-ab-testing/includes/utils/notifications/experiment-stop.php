							...
							<div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
								<div class="card"
									...
									<p style="text-align:center;margin:2rem 0 2rem">
										<a href="<?php echo esc_url( $experiment_url ); ?>" style="display:inline-block;padding:14px 32px;background:#ff7e00;border-radius:4px;font-weight:normal;letter-spacing:1px;font-size:20px;line-height:26px;color:white;text-decoration:none" target="_blank"><?php echo esc_html_x( 'See Results', 'text', 'nelio-ab-testing' ); ?></a>
									</p>

									<?php if ( 'manual' !== $end_mode && 0 === $stopper_user_id ) { ?>
									<p style="font-size: 18px; line-height: 24px;">
										<?php
										switch ( $end_mode ) {
											case 'pageviews':
