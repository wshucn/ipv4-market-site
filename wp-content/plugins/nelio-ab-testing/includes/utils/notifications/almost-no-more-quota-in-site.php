							...
							<div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
								<div class="card"
									...
									<p style="font-size: 18px; line-height: 24px;">
										<?php
											echo esc_html_x( 'This is to inform you that you might run out of quota soon, as you have less than 20% of your site’s total page views available.', 'text', 'nelio-ab-testing' );
										?>
									</p>

									<p style="font-size: 18px; line-height: 24px;">
										<?php
											echo esc_html_x( 'Note that once you run out of quota, the service will stop to track your visitors until the next quota renewal, when the number of available page views will be reset.', 'text', 'nelio-ab-testing' );
										?>
									</p>

									<p style="font-size: 18px; line-height: 24px;">
										<?php
											echo wp_kses_data( _x( 'If you want to resume the tracking right away, you can change your quota limit using the option available in your <strong>Account Details</strong> and set some additional page views.', 'text', 'nelio-ab-testing' ) );
										?>
									</p>

									<p style="text-align:center;margin:2rem 0 2rem">
										<a href="<?php echo esc_url( $account_url ); ?>" style="display:inline-block;padding:14px 32px;background:#ff7e00;border-radius:4px;font-weight:normal;letter-spacing:1px;font-size:20px;line-height:26px;color:white;text-decoration:none" target="_blank"><?php echo esc_html_x( 'Change Quota Limit', 'command', 'nelio-ab-testing' ); ?></a>
									</p>
