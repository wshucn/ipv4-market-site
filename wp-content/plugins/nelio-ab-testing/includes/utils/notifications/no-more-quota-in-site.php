							...
							<div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
								<div class="card"
									...
									<p style="font-size: 18px; line-height: 24px;">
										<?php
											echo esc_html_x( 'Your site has run out of quota. As a result, the service will not track any of your visitors until the end of your billing period, when the number of page views will be reset.', 'text', 'nelio-ab-testing' );
										?>
									</p>

									<p style="font-size: 18px; line-height: 24px;">
										<?php
											echo wp_kses_data( _x( 'If you want to ensure that the service won’t stop, you can change the quota limit using the option available in your <strong>Account Details</strong> and set some additional page views.', 'text', 'nelio-ab-testing' ) );
										?>
									</p>
