...
export const SaveButton = (): JSX.Element => {
	...
	return (
		<div className="nab-php-editor-sidebar__actions">
			<div className="nab-php-editor-sidebar__back-to-experiment">
				<a
					className="nab-php-editor-sidebar__back-to-experiment-link"
					href={ experimentUrl }
					title={ _x(
						'Back to test…',
						'command',
			...
			<div className="nab-php-editor-sidebar__save-info">
				{ isSaving && (
					<span className="nab-php-editor-sidebar__saving-label">
						<Dashicon icon="cloud" />
