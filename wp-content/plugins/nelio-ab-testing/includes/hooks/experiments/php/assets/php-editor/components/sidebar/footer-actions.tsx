...
export const FooterActions = (): JSX.Element => {
	...
	return (
		<div className="nab-php-editor-sidebar__footer-actions">
			<div
				className={ classnames( {
					'nab-php-editor-sidebar__visibility-toggle': true,
					'nab-php-editor-sidebar__visibility-toggle--hide':
						!! areVisible,
					'nab-php-editor-sidebar__visibility-toggle--show':
						! areVisible,
				} ) }
			>
				<Button
				...
				>
					{ areVisible ? (
						<>
							...
							<span className="nab-php-editor-sidebar__visibility-toggle-label">
								{ _x(
									'Hide Controls',
									'command',
									'nelio-ab-testing'
			...
			<div className="nab-php-editor-sidebar__resolutions">
				<div
					className={ classnames( {
						'nab-php-editor-sidebar__resolution': true,
						'nab-php-editor-sidebar__resolution--is-active':
							'desktop' === resolution,
					} ) }
				>
					<Button
