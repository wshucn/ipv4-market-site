...
<div class='content uk-container uk-container-large uk-margin-medium-top'>
	<div class="uk-padding uk-padding-remove-vertical" uk-grid>
		<div class="uk-width-2-3@m">
			<?php if (get_field('press_archive_title', 'options')) : ?>
				<h1 class="uk-text-primary"><?php the_field('press_archive_title', 'options'); ?></h1>
			<?php endif; ?>

			<?php if (get_field('press_archive_intro', 'options')) : ?>
				<div class="page-intro" style="line-height:1.5;">
					<?php the_field('press_archive_intro', 'options'); ?>
				</div>
			<?php endif; ?>
							...
							<div class="uk-width-1-3@m">
								<div>
									...
									if (get_post_thumbnail_id(get_the_ID())) {
										...
										$image = get_field('default_press_thumbnail', 'options');
									} ?>
